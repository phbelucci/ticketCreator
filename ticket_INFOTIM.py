...
callType = "2"
ticketData = input("Data e hora do bilhete no formato YYYYMMDDHHMMSS: ")
...
ticketDay = ticketData[7:8]
ticketHour = ticketData[9:10]
...
print(f"\n{qtdTickets} foram emitidos com sucesso, para o LA {ticketLA}. O nome do arquivo é {nomeArquivo}.")